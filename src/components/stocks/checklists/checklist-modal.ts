...
import { UpdateChecklist } from "./UpdateChecklist.mutation.graphql.js";
import { GetChecklists } from "./GetChecklists.query.graphql.js";
import "../../generic/input"; // text-input
import "../../generic/toggle-group";
import "../../generic/notification";
import "../../generic/container-card-info/container-card-info";
import "./multiple-choice";

@customElement("checklist-modal")
export class ChecklistModal extends LitElement {
    /* Properties */
    ...
    @state()
    title: String = this.checklist ? `Edit CHECKLIST '${this.checklist?.name}'` : "New CHECKLIST";
            ...
            <div class="wrapper ${this.open ? "open" : ""}">
                <header class="bg-base border-b border-contrast-10 box-border flex h-xl items-center w-full" slot="navbar">
                    <vaadin-vertical-layout class="m-auto" style="line-height: var(--lumo-line-height-m);">
                        <span id="modalTitle">${this.title}</span>
