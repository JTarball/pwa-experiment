...
import "../generic/text-area.js";
import "../generic/notification";
import "../generic/delete-confirm";
import "../generic/container-list/container-list.ts";
import "../generic/molecules/dialog-card/generic-dialog-card.ts";
...
class TickerDetail extends LitElement {
