...
import "../components/templates/stocks/ticker-detail";

@customElement("page-ticker-detail")
export class PageTickerDetail extends PageElement {
    @state()
    private items?: Stock[];
    ...
    render() {
        return html`
            ...
            <section>
                <ticker-detail .location=${this.location}></ticker-detail>
            </section>
